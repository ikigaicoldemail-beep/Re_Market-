...
Route::post('/stores', [StoreController::class, 'store'])->middleware('marketplace.verified');
Route::get('/stores/{store}', [StoreController::class, 'show']);
Route::put('/stores/{store}', [StoreController::class, 'update'])->middleware('marketplace.verified');
// Alias for multipart/form-data uploads (PHP cannot parse PUT multipart bodies).
Route::post('/stores/{store}', [StoreController::class, 'update'])->middleware('marketplace.verified');
