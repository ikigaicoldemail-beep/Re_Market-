...
class StoreApiTest extends TestCase
{
    ...
    public function test_public_store_products_can_be_loaded_by_slug(): void
    {
        $seller = User::factory()->create(['role' => 'seller']);
        ...
        $this
            ->getJson('/api/v1/stores/'.$store->slug.'/products')
            ->assertOk()
            ->assertJsonPath('store.slug', 'phnom-penh-tech-hub');
    }

    public function test_public_store_page_accepts_slug_urls(): void
    {
        $seller = User::factory()->create(['role' => 'seller']);
        Store::factory()->for($seller)->create([
            'slug' => 'phnom-penh-tech-hub',
        ...
        $this
            ->get('/stores/phnom-penh-tech-hub')
            ->assertOk();
    }
}
